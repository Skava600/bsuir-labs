...
namespace lab3
{
    class Program
    {
        public delegate void Armies(List<Unit> army1, List<Unit> army2);
        public static event Armies ShowArmies;
        ...
        public static void DisplayYelMessage(string message)
        {
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine(message);
            Console.ResetColor();
        }
        public static void DisplayBlueMessage(string message)
        {
        ...
        static void Main()
        {
            ...
            army1.Sort();
            army2.Sort();
            ShowArmies = delegate (List<Unit> army1, List<Unit> army2) // ANONYM METHOD
            {
                Console.WriteLine("\n" + new string('+', 50) + "\n1 - Cavalry 2 - Infantry 3 - Horse Archer 4 - Archer");
                DisplayBlueMessage("1 ARMY");
                ShowArmyTypes(army1);
                DisplayGreenMessage("\n2 ARMY");
                ShowArmyTypes(army2);
